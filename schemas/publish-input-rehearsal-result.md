...
status: INPUT_PATH_READY | NEEDS_VERIFIER | TARGET_NOT_FOUND | TOKEN_URL_MISSING | COMMENT_TARGET_NOT_FOUND | COMMENT_CONTEXT_UNCONFIRMED | WRONG_ELEMENT_CLICKED | REPLY_CONTEXT_UNCONFIRMED | WRONG_REPLY_TARGET | TEXT_MISMATCH | CLEAR_UNCONFIRMED | LOGIN_REQUIRED | BROWSER_ERROR | SETUP_ERROR
